...
/**
 * Processa webhooks do Mercado Pago (assinado com x-signature).
 * Usado por {@code /api/webhooks/mercadopago} e {@code /api/subscriptions/webhook}.
 */
@Service
public class MercadoPagoWebhookService {
    ...
    public MercadoPagoWebhookService(SubscriptionService subscriptionService,
    ...
    @Transactional
    public ResponseEntity<Void> processWebhook(Map<String, Object> payload,
                                               String signature,
                                               String requestId) {
        try {
